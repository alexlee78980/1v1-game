...
throw = [pygame.image.load (r'C:\Users\alexl\Documents\itachi\throw1.png'), pygame.image.load (r'C:\Users\alexl\Documents\itachi\throw2.png'), pygame.image.load (r'C:\Users\alexl\Documents\itachi\throw3.png'), pygame.image.load (r'C:\Users\alexl\Documents\itachi\throw4.png')]
class player(object):
        ...
        if not(self.standing):
            if self.isJump and self.right:
                ...
                if self.throwCount + 1 >= 12:
                    self.throwCount = 11
                win.blit(throw[itachi.throwCount//3],(self.x, self.y))
                self.throwCount += 1
        else:
            if self.left:
...
while run:
    ...
    if event.type == pygame.MOUSEBUTTONDOWN:
        ...
        shield = projectile(itachi.down[0],itachi.down[1], 1)
        itachi.created = True
